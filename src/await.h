    ...
    namespace await
    {
        ...
        public:
                ...
                std::function<void()> handler)
            {
                ...
                std::thread t(block, this, blocker, handler, false);
            ...
            {
                // start blocking function in its own thread
                std::thread t(block, this, blocker, handler, true);
        ...
        private:
            ...
            */
            ...
            /** Run blocking function, post event handler on completion
             * @param[in] blocker
             * @param[in] handler
             * @param[in] repeat true if blocker should run repeatedly, default false
             *
